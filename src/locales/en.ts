export const en = {
  ...
  contact: {
    ...
    evening: "Evening",
    sunday: "Sunday",
    sundayClosed: "Closed (Emergency Calls Only)",
    bookBtn: "Book Appointment",
    note1: "Typically responds within 2 hours",
    note2: "In-person & teleconsultation available",
    bookingAlert: "Thank you! Please call or message us via WhatsApp to book a slot directly."
  },
  footer: {
    tagline: "“Compassionate women's healthcare, every stage of life.”",
